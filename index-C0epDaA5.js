const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["Home-Bat9nV3G.js","vendor-BHPvmmhE.js","use-query-D-qmeKJI.js","assets/Home-CPey3KJv.css","StickerPackDetail-BdoK_lwo.js","assets/StickerPackDetail-KBr5LiUc.css","Contribute-BguQXxVA.js","ContributionStatus-B7X5sOs1.js","About-zB77wCWY.js","Report-CYzycPsX.js"])))=>i.map(i=>d[i]);
...
const Home = React.lazy(async () => __vitePreload(() => import("./Home-Bat9nV3G.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const Pack = React.lazy(async () => __vitePreload(() => import("./StickerPackDetail-BdoK_lwo.js"), true ? __vite__mapDeps([4,1,2,5]) : void 0));
const Contribute = React.lazy(async () => __vitePreload(() => import("./Contribute-BguQXxVA.js"), true ? __vite__mapDeps([6,1]) : void 0));
const ContributionStatus = React.lazy(async () => __vitePreload(() => import("./ContributionStatus-B7X5sOs1.js"), true ? __vite__mapDeps([7,1]) : void 0));
const About = React.lazy(async () => __vitePreload(() => import("./About-zB77wCWY.js"), true ? __vite__mapDeps([8,1]) : void 0));
const Report = React.lazy(async () => __vitePreload(() => import("./Report-CYzycPsX.js"), true ? __vite__mapDeps([9,1]) : void 0));
function AppLayout() {
  const useAppState = React.useContext(Context$1);
...
//# sourceMappingURL=index-C0epDaA5.js.map
