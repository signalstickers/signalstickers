 ...
 *
 * This is a custom build of Modernizer that only detects WebP support. We use
 * this to determine when to convert WebP images to PNG images on browsers that
 * do not support WebP.
 */
